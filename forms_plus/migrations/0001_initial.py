...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Form'
        db.create_table(u'forms_plus_form', (
        ...
        db.send_create_signal(u'forms_plus', ['Form'])

        # Adding model 'Field'
        db.create_table(u'forms_plus_field', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fields', to=orm['forms_plus.Form'])),
        ...
        db.send_create_signal(u'forms_plus', ['Field'])

        # Adding model 'FormEntry'
        db.create_table(u'forms_plus_formentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'entries', to=orm['forms_plus.Form'])),
            ('entry_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'forms_plus', ['FormEntry'])

        # Adding model 'FieldEntry'
        db.create_table(u'forms_plus_fieldentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'fields', to=orm['forms_plus.FormEntry'])),
        ...
        db.send_create_signal(u'forms_plus', ['FieldEntry'])


    def backwards(self, orm):
        # Deleting model 'Form'
        db.delete_table(u'forms_plus_form')

        # Deleting model 'Field'
        db.delete_table(u'forms_plus_field')

        # Deleting model 'FormEntry'
        db.delete_table(u'forms_plus_formentry')

        # Deleting model 'FieldEntry'
        db.delete_table(u'forms_plus_fieldentry')
    ...
    models = {
        u'forms_plus.field': {
            ...
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'fields'", 'to': u"orm['forms_plus.Form']"}),
        ...
        u'forms_plus.fieldentry': {
            'Meta': {'object_name': 'FieldEntry'},
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'fields'", 'to': u"orm['forms_plus.FormEntry']"}),
        ...
        u'forms_plus.formentry': {
            'Meta': {'object_name': 'FormEntry'},
            'entry_time': ('django.db.models.fields.DateTimeField', [], {}),
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'entries'", 'to': u"orm['forms_plus.Form']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'pages.page': {
